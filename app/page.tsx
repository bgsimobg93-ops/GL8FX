    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-14 lg:grid-cols-[1.1fr,0.9fr]">
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <Link
            href="/apex-monitor"
            className="mt-6 flex items-center gap-2 rounded-2xl border border-slate-200 bg-slate-50 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100"
          >
            <Activity className="h-4 w-4 text-yellow-600" />
            Open Apex Balance Monitor
          </Link>
        </div>
      </section>
    </div>
